...
| 29 | CodeHunt/Rainbound | CodeHunt, Rainbound | Shaman  | Healer (Resto)           | —                       | 2        | Was hunter (CodeHunt), now healer shaman (Rainbound). Sometimes still signs up under "CodeHunt" when playing Rainbound |
| 30 | Ebonybolt          | Ebonybolt           | Shaman  | DPS (Enhancement, melee) | Healer (Resto)          | 2        | Strongly prefers DPS, can help with healing every now and then                                                          |
| 31 | Lynelen            | Lynelen             | Shaman  | DPS (Enhancement, melee) | DPS (Elemental, ranged) | 2        | Switches spec willingly if needed                                                                                       |
| 32 | Pergatori          | Pergatori           | Shaman  | DPS (Elemental, ranged)  | Healer (Resto)          | 2        | Usually Elemental, switches to healing willingly if needed                                                              |
...
| 41 | Spot/Yorekbarn     | Spot, Yorekbarn     | Warrior | DPS                      | —                       | 2        | Same person, 2 chars. Previously known as Spot/Yorek                                                                    |
