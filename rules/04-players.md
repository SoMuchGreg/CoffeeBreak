...
|---|----------------------|--------------------------------|---------|-----------------|----------------|----------|----------------------------------------------------------|
| 1 | Guðjón(Jarðepli)     | Jarðepli, Jardepli, Jar        | Druid   | DPS (Balance)   | Healer         | 1        | First line offspec                                       |
| 2 | Mark(Roossy/Keatala) | Roossy, Keatala                | Hunter  | DPS             | —              | 1        | Druid alt (Keatala) — see Alt characters sub-table below |
| 3 | Greg(Ucannotpass)    | Ucannotpass                    | Mage    | DPS             | —              | 1        |                                                          |
| 4 | Emil(Ostbirger)      | Ostbirger                      | Paladin | Tank            | DPS            | 1        | Core tank, Main tank                                     |
| 5 | Adam(Kres/Dissi)     | Kresniik, Dissidencer, Griever | Priest  | DPS             | Healer         | 1        | First line offspec                                       |
...
| 2 | Kamil(Gigakox)   | Gigakox      | Warrior | Tank            | DPS (Fury)     | 1        | 3rd tank, First line offspec |
...
| 2  | Kylthar                 | Kylthar         | Druid   | Healer             | ?                 | 2        | Decide to machine-demote or ingame-promote by 2026-07-26                                           |
| 3  | Shapkica                | Shapkica        | Druid   | DPS (Feral)        | Tank (Feral)      | 2        | Eager offspec                                                                                      |
| 4  | Stephan(Tímmâ/Toadward) | Tímmâ, Toadward | Druid   | DPS (Balance)      | Healer            | 2        | Eager offspec                                                                                      |
| 5  | Yxanb                   | Yxanb           | Druid   | DPS (Feral)        | Tank (Feral)      | 2        | Reluctant offspec                                                                                  |
| 6  | loranzoo                | loranzoo        | Hunter  | DPS (Beastmastery) | ?                 | 2        | Decide to machine-demote or ingame-promote by 2026-07-12                                           |
| 7  | Mathias(Vaelruna)       | Vaelruna        | Hunter  | DPS (Beastmastery) | —                 | 2        |                                                                                                    |
| 8  | Silverpilen             | Silverpilen     | Hunter  | DPS (Beastmastery) | —                 | 2        |                                                                                                    |
| 9  | Samoen&Co.              | Samoen&Co.      | Mage    | DPS (Arcane)       | ?                 | 2        | Decide to machine-demote or ingame-promote by 2026-07-26                                           |
| 10 | Thomas(PowerBlastin)    | PowerBlastin    | Mage    | DPS (Arcane)       | ?                 | 2        | Decide to machine-demote or ingame-promote by 2026-07-15. Sometimes signs up as SydM107 on Discord |
| 11 | TJ(Animustenax)         | Animustenax     | Mage    | DPS (Arcane)       | —                 | 2        | Also referred to as Ani; she/her                                                                   |
| 12 | Heligeman               | Heligeman       | Paladin | Healer             | —                 | 2        | Often addressed as Helige                                                                          |
| 13 | Thordrel                | Thordrel        | Paladin | Healer             | —                 | 2        |                                                                                                    |
| 14 | Lightweit               | Lightweit       | Priest  | Healer             | —                 | 2        |                                                                                                    |
| 15 | Saskia(Siljes)          | Siljes          | Priest  | Healer             | DPS               | 2        | Eager offspec                                                                                      |
| 16 | Tim(Tiinar)             | Tiinar          | Rogue   | DPS (Combat)       | —                 | 2        |                                                                                                    |
| 17 | Ebonybolt               | Ebonybolt       | Shaman  | DPS (Enhancement)  | Healer            | 2        | Ok to offspec                                                                                      |
| 18 | Pergatori               | Pergatori       | Shaman  | Healer             | DPS (Elemental)   | 2        | First line offspec                                                                                 |
| 19 | Piotr(Bergamotka)       | Bergamotka      | Shaman  | DPS (Enhancement)  | DPS (Elemental)   | 2        | Ok to offspec                                                                                      |
| 20 | Steven(Gresac/Younea)   | Younea, Gresac  | Shaman  | DPS (Elemental)    | Healer            | 2        | First line offspec. Druid alt (Gresac) — see Alt characters sub-table                              |
| 21 | Jabbadhutt              | Jabbadhutt      | Warlock | DPS (Destruction)  | DPS (Affliction)  | 2        |                                                                                                    |
| 22 | Quoterlock              | Quoter          | Warlock | DPS (Affliction)   | DPS (Destruction) | 2        | Decide to machine-demote or ingame-promote by 2026-07-12                                           |
| 23 | Rickard(Benglock)       | Benglock        | Warlock | DPS (Destruction)  | —                 | 2        |                                                                                                    |
| 24 | CptKavior               | CptKavior       | Warrior | DPS (Fury)         | Tank              | 2        | First line offspec                                                                                 |
| 25 | Dankyn                  | Dankyn          | Warrior | DPS (Fury)         | Tank              | 2        | Reluctant offspec                                                                                  |
| 26 | Lanoxian                | Lanoxian        | Warrior | DPS (Fury)         | —                 | 2        | Decide to machine-demote or ingame-promote by 2026-07-19                                           |
| 27 | Sören(Verysadge)        | Verysadge       | Warrior | DPS (Fury)         | —                 | 2        |                                                                                                    |
...
| 3  | Jordan(Grundiger)    | Grundiger       | Hunter  | DPS (Beastmastery)  | —                | 3        | Discord name: grundi21   |
| 4  | Tonz/Tonsen          | Tonsen          | Hunter  | DPS (Beastmastery)  | —                | 3        |                          |
| 5  | Mark(Mellymel)       | Mellymel, Lenno | Mage    | DPS (Arcane)        | —                | 3        |                          |
| 6  | Leontes              | Leontes         | Paladin | DPS                 | —                | 3        |                          |
| 7  | McJudgin             | McJudgin        | Paladin | DPS                 | Tank             | 3        | First line offspec       |
| 8  | Sjwammie             | Sjwammie        | Paladin | Healer              | —                | 3        |                          |
| 9  | Boriest              | Boriest         | Priest  | Healer              | DPS              | 3        | Eager offspec            |
| 10 | Medianos             | Medianos        | Priest  | DPS                 | ?                | 3        |                          |
| 11 | Lynelen              | Lynelen, Kalyl  | Shaman  | DPS (Enhancement)   | DPS (Elemental)  | 3        | Ok to offspec            |
| 12 | BestPractice         | BestPractice    | Warlock | DPS                 | —                | 3        |                          |
| 13 | McHughes             | McHughes        | Warlock | DPS                 | —                | 3        |                          |
| 14 | David(Nemajumarad)   | Nemajumarad     | Warrior | DPS (Arms)          | Tank             | 3        | Eager offspec            |
| 15 | Doughball            | Doughball       | Warrior | DPS (Fury)          | Tank             | 3        | Eager offspec            |
| 16 | Varva                | Varva           | Warrior | DPS                 | —                | 3        |                          |
| 17 | Yorekbarn            | Yorekbarn       | Warrior | DPS (Fury)          | —                | 3        |                          |
...
|-----------------------|-----------|-------|-----------------|----------------|-------|
| Steven(Gresac/Younea) | Gresac    | Druid | Healer          | DPS (Balance)  |       |
| Mark(Roossy/Keatala)  | Keatala   | Druid | Healer          | —              |       |
