...
- **Everything else preserved.** Priority levels, composition caps, user discretion, bench reason vocabulary, the cross-location tiebreaker, and the Karazhan class-diversity / class-desirability tiers all still apply — each within the per-role rotation it governs.
