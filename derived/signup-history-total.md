...
| # | Player               | Signups |
|---|----------------------|---------|
| 1 | Greg(Ucannotpass)    | 41      |
| 2 | Adam(Kres/Dissi)     | 36      |
| 3 | Mark(Roossy/Keatala) | 30      |
| 4 | Emil(Ostbirger)      | 27      |
| 5 | Guðjón(Jarðepli)     | 27      |

### Core tanks

| # | Player           | Signups |
|---|------------------|---------|
| 1 | Marino(Varthier) | 41      |
| 2 | Kamil(Gigakox)   | 23      |
...
| #  | Player                  | Signups |
|----|-------------------------|---------|
| 1  | Mathias(Vaelruna)       | 40      |
| 2  | Steven(Gresac/Younea)   | 40      |
| 3  | Sören(Verysadge)        | 39      |
| 4  | Thordrel                | 32      |
| 5  | Beaverfist              | 31      |
| 6  | Piotr(Bergamotka)       | 31      |
| 7  | Yxanb                   | 31      |
| 8  | Dankyn                  | 27      |
| 9  | Jabbadhutt              | 27      |
| 10 | Pergatori               | 26      |
