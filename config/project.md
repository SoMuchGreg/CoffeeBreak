...
| **Offspec signup** | A signup-time choice: a player clicks their offspec icon on the signup screen rather than their mainspec icon. For how it affects roster placement, see `rules/01-raid-compositions.md` → "Role placement: mainspec is authoritative". |
