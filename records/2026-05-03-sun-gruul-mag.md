...
**Warlocks (2):** Jabbadhutt, McHughes
...
| Kiggler Tank         | Greg, Vaelruna         | 2 ranged DPS; Vaelruna joins after MDing Blindeye  |
...
|-----------------|------|------------------|--------------------------|---------------|
| Marino-Varthier | Tank | 3                | NE×3                     | 2026-04-15 NE |
| Ostbirger       | Tank | 3                | NW×3                     | 2026-04-15 NW |
| Kres/Dissi      | DPS  | 2                | S×1, SW×1                | 2026-04-26 SW |
...
|----------------|----------|-------------------------------------------|---------------|
| Siljes/Ejlis   | 2        | 1                                         | fair rotation |
...
- **Beaverfist signed up Resto** (offspec from main DPS Balance, standing first-line-offspec note). Tier 0 didn't formally fire (Healer over-rep at 7/6, not under-rep) but she chose Resto regardless; treated as her per-raid choice.
- **Bench picks:**
  - **Siljes/Ejlis (fair rotation)** — among the four 0-G+M-bench healers, Holy Priest over-rep (2 vs §8 range 1) → in-range after bench. User excluded Boriest from the bench pool.
...
- **Cube clickers (leader directive):** S Jabbadhutt (step-4 — neither Warlock has S history; McHughes preserved for SW continuity), SE Greg (continuity 04-15, 04-12), SW McHughes (continuity 04-15), NE CptKavior (continuity 04-26), NW Gigakox (continuity 04-26). Marino-Varthier and Ostbirger remain cube-free as Mag MT reserve. Kres/Dissi off cubes per leader; Greg moved off S to SE per leader. Strict algorithm (with Greg removed from S and Kres excluded) would have placed Kres at S (only S continuity in roster after Greg/Pergatori excluded).
...
- **Cube clickers reshuffled:** S ← Jabbadhutt (was Greg, then Kres after Greg removed); SE ← Greg (was Jabbadhutt); SW ← McHughes (was Kres/Dissi); NE/NW unchanged. Kres/Dissi off all cubes; Greg off S, on SE.
