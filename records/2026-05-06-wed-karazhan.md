...
**Tanks (3):** CptKavior, Ostbirger, McJudgin
**Warriors (3):** Gigakox, Verysadge, Dankyn
**Druids (5):** Jar, Beaverfist, Shapkica/Chkemi, Yxanb, Gyrodorei
...
| Shapkica/Chkemi     | OT     | Druid (Feral)        |
...
| Shapkica/Chkemi | DPS (Feral) → Tank (Feral)   | 1    | Yes       | Eager offspec; covering Marino-Varthier withdrawal; OT on Restaurant          |
...
- **Soft rule violations forced by signups**: Bakery has no Priest healer (only 2 in raid: Siljes R, Lightweit WP); Hunter / Mage / Warlock each have only 2 signups → 1-1-0 distribution (Bakery missing Mage and Warlock; WellPrepared missing Hunter); Fury Warrior 0-1-1 split (only 2 Fury after Nemajumarad's flex).
...
| Skulker's Greaves             | Bergamotka/Tymoti (WP), Dankyn (Bak), Gigakox (R)                    | ✓ split                                         |
| Spiteblade                    | Dankyn (Bak), Gigakox (R)                                            | ✓ split                                         |
| The Decapitator               | Bergamotka/Tymoti (WP), Lynelen (R)                                  | ✓ split                                         |
