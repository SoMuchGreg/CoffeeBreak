...
- **Post-build swaps (user instruction)**:
  - Roossy/Keatala (Hunter) ↔ Shapkica (Feral) between Restaurant and Bakery — de-stacks ferals on Restaurant; makes Roossy R's officer.
...
- Roossy/Keatala (Bakery DPS) ↔ Shapkica (Restaurant DPS) per user instruction — de-stacks Druid Ferals on R; brings Roossy to R as officer.
