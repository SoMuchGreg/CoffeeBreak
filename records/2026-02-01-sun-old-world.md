# ZG + AQ20 — Sunday 01.02.2026

> Old World raid (historical record, signups only — no roster formed). See `config/project.md` → "Old World raids".

## Signups (from Discord) — 14 (+3)

**Tanks (3):** Mirohl, Marino(Varthier), CoffeeBean
**Warriors (2):** Ryro, Mairen/Zorÿa
**Druids (1):** Steven(Gresac/Younea)
...
**Header stats:** Melee 3/4, Ranged 6, Healers 1
