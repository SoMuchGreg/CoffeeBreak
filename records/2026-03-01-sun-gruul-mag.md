# Gruul + Magtheridon — Sunday 01.03.2026

> Historical record, signups only — no roster formed for this retro-recorded raid. Discord description: *"Gruul + Mag."*
...
<!-- Retro-recorded from Discord assignments post dated 01.03.2026 01:49. Pre-rule-05 label "Boomy Tank" normalized to "Kiggler Tank". -->
...
- Source Discord post also carried out-of-scope content (Gruul the Dragonkiller tanks/healers/MDs, Magtheridon Phase 1 add tanks per compass direction, Burning Abyssal banishers, Magtheridon main-fight tanks/healers) — not recorded per `rules/05-encounter-assignments.md` → "Intentionally out of scope".
